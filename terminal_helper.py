...
from shutil import _make_zipfile as zip
...
class Terminal_helper():
    ...
    def th_help(self):
        print("as the names states this is a terminal helper for linux you could print stuff and delete stuff. for writing a note print notepad for cd.. print left arrow for cd / print left arrow twice for going to privios dir press right key for home press right key twice for open a file press o. Delete press o and if you get bored print bash")
